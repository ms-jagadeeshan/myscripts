...
public:
    ...
    {
        if (day == day_ && hour == hour_ && minute == minute_)
        {
            cout << link;
        }
    }
...
{
    timings a[20] = {
        {8, 55, 1, "https://meet.google.com/qzi-ywmf-cry"},
        {9, 55, 1, "https://meet.google.com/zic-wtjg-maw"},
        ...
        {8, 55, 2, "https://meet.google.com/zic-wtjg-maw"},
        ...
        {14, 55, 2, "https://meet.google.com/qbm-bxsc-dvg"}, //Programming practice
        {13, 55, 3, "https://meet.google.com/osi-mxea-jpc"},
        ...
        {13, 55, 4, "https://meet.google.com/osi-mxea-jpc"},
        {9, 55, 5, "https://meet.google.com/juj-fhmq-yrm"},
        {10, 55, 5, "https://meet.google.com/zic-wtjg-maw"},
